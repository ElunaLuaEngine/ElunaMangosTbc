                    ...
                    case ARAN_ACTION_SUPERSPELL:
                    {
						...
						switch (m_uiLastSuperSpell)
                        {
                            case SUPER_ARCANE_EXPL:
								DoCastSpellIfCan(m_creature, SPELL_TELEPORT_MIDDLE, CAST_TRIGGERED);
...
struct npc_shade_of_aran_blizzardAI : public ScriptedAI
{
	...
	{
		blizzardWaypoints[0][0] = -11154.3f;    blizzardWaypoints[1][0] = -1903.3f;
		blizzardWaypoints[0][1] = -11163.6f;    blizzardWaypoints[1][1] = -1898.7f;
		blizzardWaypoints[0][2] = -11173.6f;    blizzardWaypoints[1][2] = -1901.2f;
		blizzardWaypoints[0][3] = -11178.1f;    blizzardWaypoints[1][3] = -1910.4f;
		blizzardWaypoints[0][4] = -11175.4f;    blizzardWaypoints[1][4] = -1920.6f;
		blizzardWaypoints[0][5] = -11166.6f;    blizzardWaypoints[1][5] = -1925.1f;
		blizzardWaypoints[0][6] = -11156.5f;    blizzardWaypoints[1][6] = -1922.8f;
		blizzardWaypoints[0][7] = -11151.8f;    blizzardWaypoints[1][7] = -1913.5f;
	}
	...
	void SpellHit(Unit* caster, const SpellEntry* spell) override
	{
		if (spell->Id == SPELL_SUMMON_BLIZZARD)
		{
			...
			uint64 AranGUID = 0;
			if (m_pInstance)
				if (Creature* pAran = m_pInstance->GetSingleCreatureFromStorage(NPC_MIDNIGHT))
				{
					m_creature->CastSpell(m_creature, 29952, TRIGGERED_NONE);
				}
			...
			wLoc.coord_z = m_creature->GetPositionZ();

			m_creature->NearTeleportTo(wLoc.coord_x, wLoc.coord_y, wLoc.coord_z, m_creature->GetOrientation(), false);
