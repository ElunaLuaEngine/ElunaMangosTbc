...
class WorldObject : public Object
{
    ...
    public:
		...
		void GetValidPointInAngle(float &x, float &y, float &z, float dist, float angle, bool meAsSourcePo, bool ignoreLOSOffset = false, float allowHeightDifference = 4.3) const;
