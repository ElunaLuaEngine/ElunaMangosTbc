...
void WorldSession::HandlePlayerLogin(LoginQueryHolder* holder)
{
	...
	PlayerMenu* pMenu = pCurrChar->PlayerTalkClass;
	pMenu->ClearMenus();
	pMenu->GetGossipMenu().AddMenuItem(1, "", 0, 1000, GetMangosString(LANG_LOGIN_GET_MANGOS_SRTING), 0);
	pMenu->SendGossipMenu(1, pCurrChar->GetObjectGuid());
